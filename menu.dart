...
class MenuPage extends StatefulWidget {
  final bool showWeeklyMenu;

  const MenuPage({super.key, this.showWeeklyMenu = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(Icons.calendar_month, color: Color(0xFF1A2980)),
            onPressed: () {
              Navigator.push(
                context,
        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<Map<String, List<String>>>(
              future: _loadDayMenu(currentDay),
